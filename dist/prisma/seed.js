...
const seedProductTemplates = async () => {
    ...
    if (fallbackGlass) {
        await upsertTemplateVersion({
            ...
            description: "Plantilla simple de panel fijo de vidrio para vistas previas rápidas de simulación.",
            inputs: [
                {
            ...
            productType: "WINDOW",
            status: "ACTIVE",
            templateDescription: "Definiciones reutilizables de panel fijo de vidrio para futuros flujos de cotización.",
    ...
    if (fallbackGlass && fallbackAluminumProfile) {
        await upsertTemplateVersion({
            ...
            description: "Aproximación básica de ventana corrediza con una regla de vidrio y una regla de perímetro de aluminio.",
            inputs: [
                {
                    defaultValueJson: Prisma.JsonNull,
                    inputType: "NUMBER",
            ...
            notes: "Aproximación inicial para futuros flujos de cotización y optimización de múltiples paneles.",
            productType: "WINDOW",
            status: "ACTIVE",
            templateDescription: "Plantilla reutilizable de ventana corrediza con reglas de vista previa para vidrio y aluminio.",
    ...
    if (fallbackMirror) {
        await upsertTemplateVersion({
            ...
            productType: "MIRROR",
            status: "ACTIVE",
            templateDescription: "Plantilla reutilizable de espejo para futuros flujos de simulación y cotización.",
            templateName: "Mirror",
        });
        seededCount += 1;
    }
