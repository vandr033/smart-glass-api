...
const runBestEffortAuthSideEffect = async (label, effect, meta) => {
    try {
        await effect();
    }
    catch (error) {
    ...
    databaseHooks: {
        account: {
            create: {
                after: async (account) => {
                    if (account.providerId === "credential") {
                        await runBestEffortAuthSideEffect("sync credential password after account create", async () => {
            ...
            update: {
                after: async (account) => {
                    if (account.providerId === "credential") {
                        await runBestEffortAuthSideEffect("sync credential password after account update", async () => {
                            await syncCredentialPassword(account.userId, account.password);
                        }, {
                            providerId: account.providerId,
                            userId: account.userId,
