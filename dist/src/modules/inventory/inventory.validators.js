...
import { DAMAGE_SEVERITIES, DAMAGE_TYPES, DAMAGED_MATERIAL_STATUSES, INVENTORY_CONDITIONS, INVENTORY_MOVEMENT_TYPES, INVENTORY_RESERVATION_STATUSES, INVENTORY_RESERVATION_TYPES, INVENTORY_SOURCE_TYPES, INVENTORY_STOCK_TYPES, REMNANT_PIECE_SOURCE_TYPES, REMNANT_PIECE_STATUSES, WAREHOUSE_STATUSES, } from "./inventory.constants.js";
...
const nonZeroNumberSchema = (label) => z
    .union([z.number(), z.string()])
    .transform((value) => {
    if (typeof value === "string") {
        return Number(value.trim());
