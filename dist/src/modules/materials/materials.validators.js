...
import { MATERIAL_STATUSES, MATERIAL_TYPES, MATERIAL_UNITS, SUPPLIER_MATERIAL_EQUIVALENCE_CONFIDENCE_LEVELS, SUPPLIER_MATERIAL_EQUIVALENCE_STATUSES, validateMaterialBehavior, } from "./materials.behavior.js";
...
export const supplierMaterialEquivalenceConfidenceSchema = z.enum(SUPPLIER_MATERIAL_EQUIVALENCE_CONFIDENCE_LEVELS);
export const supplierMaterialEquivalenceStatusSchema = z.enum(SUPPLIER_MATERIAL_EQUIVALENCE_STATUSES);
...
export const materialMutationSchema = z
    ...
    const validation = validateMaterialBehavior(value);
...
export const createMaterialDimensionPresetSchema = materialDimensionPresetMutationSchema;
export const updateMaterialDimensionPresetSchema = materialDimensionPresetMutationSchema;
...
export const createSupplierMaterialEquivalenceSchema = supplierMaterialEquivalenceMutationSchema;
export const updateSupplierMaterialEquivalenceSchema = supplierMaterialEquivalenceMutationSchema;
...
//# sourceMappingURL=materials.validators.js.map