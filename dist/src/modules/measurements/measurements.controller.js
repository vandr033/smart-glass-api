...
import { MEASUREMENTS_ENTITY_TYPES, MEASUREMENTS_PERMISSIONS, } from "./measurements.constants.js";
import { measurementsService } from "./measurements.service.js";
import { cancelMeasurementRequestSchema, createMeasurementOpeningSchema, createMeasurementRequestSchema, createTechnicalObservationSchema, listMeasurementRequestsQuerySchema, measurementCalendarQuerySchema, measurementDecisionSchema, measurementEvidenceMetadataSchema, measurementOpeningIdParamSchema, measurementRequestIdParamSchema, reprogramMeasurementRequestSchema, resolveTechnicalObservationSchema, scheduleMeasurementRequestSchema, startMeasurementVisitSchema, submitMeasurementApprovalSchema, technicalObservationIdParamSchema, updateMeasurementOpeningSchema, updateMeasurementRequestSchema, } from "./measurements.validators.js";
...
const getRequiredRequestId = (value) => {
...
const getRequiredOpeningId = (value) => {
...
export const measurementsController = {
    async listMeasurementRequests(request, response) {
    ...
    async listMeasurementCalendar(request, response) {
    ...
    async getMeasurementRequestById(request, response) {
        const result = await measurementsService.getMeasurementRequestById(getRequiredRequestId(request.params.id));
        sendSuccess(response, result);
    },
    async createMeasurementRequest(request, response) {
        const payload = createMeasurementRequestSchema.parse(request.body);
        const actorContext = getRequestLogActorContext(request);
        const result = await measurementsService.createMeasurementRequest(payload, actorContext.userId ?? null);
    ...
    async updateMeasurementRequest(request, response) {
        ...
        const actorContext = getRequestLogActorContext(request);
        const result = await measurementsService.updateMeasurementRequest(requestId, payload, actorContext.userId ?? null);
        await logActivityEvent(request, {
    ...
    async scheduleMeasurementRequest(request, response) {
        const requestId = getRequiredRequestId(request.params.id);
        const previous = await measurementsService.getMeasurementRequestById(requestId);
        const payload = scheduleMeasurementRequestSchema.parse(request.body);
        const actorContext = getRequestLogActorContext(request);
        const result = await measurementsService.scheduleMeasurementRequest(requestId, payload, actorContext.userId ?? null);
        await logActivityEvent(request, {
    ...
    async reprogramMeasurementRequest(request, response) {
        const requestId = getRequiredRequestId(request.params.id);
        const previous = await measurementsService.getMeasurementRequestById(requestId);
        const payload = reprogramMeasurementRequestSchema.parse(request.body);
        const actorContext = getRequestLogActorContext(request);
        const result = await measurementsService.reprogramMeasurementRequest(requestId, payload, actorContext.userId ?? null);
        await logActivityEvent(request, {
            action: MEASUREMENTS_PERMISSIONS.schedule,
            entityId: result.id,
            entityType: MEASUREMENTS_ENTITY_TYPES.request,
    ...
    async cancelMeasurementRequest(request, response) {
        const requestId = getRequiredRequestId(request.params.id);
        const previous = await measurementsService.getMeasurementRequestById(requestId);
        const payload = cancelMeasurementRequestSchema.parse(request.body);
        const actorContext = getRequestLogActorContext(request);
        const result = await measurementsService.cancelMeasurementRequest(requestId, payload, actorContext.userId ?? null);
        await logActivityEvent(request, {
    ...
    async startMeasurementVisit(request, response) {
        const requestId = getRequiredRequestId(request.params.id);
        const previous = await measurementsService.getMeasurementRequestById(requestId);
        const payload = startMeasurementVisitSchema.parse(request.body);
        const actorContext = getRequestLogActorContext(request);
        const result = await measurementsService.startMeasurementVisit(requestId, payload, actorContext.userId ?? null);
        await logActivityEvent(request, {
    ...
    async createMeasurementOpening(request, response) {
        const requestId = getRequiredRequestId(request.params.id);
        const previous = await measurementsService.getMeasurementRequestById(requestId);
        const payload = createMeasurementOpeningSchema.parse(request.body);
        const actorContext = getRequestLogActorContext(request);
        const result = await measurementsService.createMeasurementOpening(requestId, payload, actorContext.userId ?? null);
        await logActivityEvent(request, {
            action: MEASUREMENTS_PERMISSIONS.execute,
            entityId: result.id,
    ...
    async updateMeasurementOpening(request, response) {
        ...
        const actorContext = getRequestLogActorContext(request);
        const result = await measurementsService.updateMeasurementOpening(openingId, payload, actorContext.userId ?? null);
        await logActivityEvent(request, {
            action: MEASUREMENTS_PERMISSIONS.update,
            entityId: openingId,
            entityType: MEASUREMENTS_ENTITY_TYPES.opening,
    ...
    async duplicateMeasurementOpening(request, response) {
        const openingId = getRequiredOpeningId(request.params.openingId);
        const actorContext = getRequestLogActorContext(request);
        const result = await measurementsService.duplicateMeasurementOpening(openingId, actorContext.userId ?? null);
        await logActivityEvent(request, {
            action: MEASUREMENTS_PERMISSIONS.update,
            entityId: openingId,
            entityType: MEASUREMENTS_ENTITY_TYPES.opening,
    ...
    async uploadMeasurementEvidence(request, response) {
        const requestId = getRequiredRequestId(request.params.id);
        ...
        const actorContext = getRequestLogActorContext(request);
        const result = await measurementsService.uploadMeasurementEvidence(requestId, payload, {
            buffer: file.buffer,
    ...
    async createTechnicalObservation(request, response) {
        const requestId = getRequiredRequestId(request.params.id);
        const previous = await measurementsService.getMeasurementRequestById(requestId);
        const payload = createTechnicalObservationSchema.parse(request.body);
        const actorContext = getRequestLogActorContext(request);
        const result = await measurementsService.createTechnicalObservation(requestId, payload, actorContext.userId ?? null);
        await logActivityEvent(request, {
            action: MEASUREMENTS_PERMISSIONS.execute,
            entityId: result.id,
    ...
    async resolveTechnicalObservation(request, response) {
        ...
        const actorContext = getRequestLogActorContext(request);
        const result = await measurementsService.resolveTechnicalObservation(observationId, payload, actorContext.userId ?? null);
        await logActivityEvent(request, {
            action: MEASUREMENTS_PERMISSIONS.update,
    ...
    async submitMeasurementForApproval(request, response) {
        const requestId = getRequiredRequestId(request.params.id);
        const previous = await measurementsService.getMeasurementRequestById(requestId);
        const payload = submitMeasurementApprovalSchema.parse(request.body);
        const actorContext = getRequestLogActorContext(request);
        const result = await measurementsService.submitMeasurementForApproval(requestId, payload, actorContext.userId ?? null);
        await logActivityEvent(request, {
            action: MEASUREMENTS_PERMISSIONS.execute,
            entityId: result.id,
            entityType: MEASUREMENTS_ENTITY_TYPES.request,
    ...
    async approveMeasurementRequest(request, response) {
        const requestId = getRequiredRequestId(request.params.id);
        const previous = await measurementsService.getMeasurementRequestById(requestId);
        const payload = measurementDecisionSchema.parse(request.body);
        const actorContext = getRequestLogActorContext(request);
        const result = await measurementsService.approveMeasurementRequest(requestId, payload, actorContext.userId ?? null);
        await logActivityEvent(request, {
    ...
    async rejectMeasurementRequest(request, response) {
        const requestId = getRequiredRequestId(request.params.id);
        const previous = await measurementsService.getMeasurementRequestById(requestId);
        const payload = measurementDecisionSchema.parse(request.body);
        const actorContext = getRequestLogActorContext(request);
        const result = await measurementsService.rejectMeasurementRequest(requestId, payload, actorContext.userId ?? null);
        await logActivityEvent(request, {
    ...
    async createQuotationFromMeasurement(request, response) {
        const requestId = getRequiredRequestId(request.params.id);
        const actorContext = getRequestLogActorContext(request);
        const result = await measurementsService.createQuotationFromMeasurement(requestId, actorContext.userId ?? null);
        await logActivityEvent(request, {
