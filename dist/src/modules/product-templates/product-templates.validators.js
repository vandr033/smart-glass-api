...
import { PRODUCT_TEMPLATE_INPUT_TYPES, PRODUCT_TEMPLATE_LABOR_TYPES, PRODUCT_TEMPLATE_MATERIAL_RULE_TYPES, PRODUCT_TEMPLATE_STATUSES, PRODUCT_TEMPLATE_TYPES, PRODUCT_TEMPLATE_VERSION_STATUSES, } from "./product-templates.constants.js";
...
export const productTemplateStatusSchema = z.enum(PRODUCT_TEMPLATE_STATUSES);
export const productTemplateVersionStatusSchema = z.enum(PRODUCT_TEMPLATE_VERSION_STATUSES);
export const productTemplateInputTypeSchema = z.enum(PRODUCT_TEMPLATE_INPUT_TYPES);
export const productTemplateMaterialRuleTypeSchema = z.enum(PRODUCT_TEMPLATE_MATERIAL_RULE_TYPES);
export const productTemplateLaborTypeSchema = z.enum(PRODUCT_TEMPLATE_LABOR_TYPES);
...
const productTemplateInputMutationSchema = z
    ...
    key: z
        ...
        message: "Input key must start with a letter and contain only letters, numbers, and underscores.",
    }),
...
//# sourceMappingURL=product-templates.validators.js.map