...
import { PROJECT_ATTACHMENT_TYPES, PROJECT_NOTE_VISIBILITIES, PROJECT_PRIORITIES, PROJECT_STATUSES, PROJECT_TYPES, } from "./projects.constants.js";
...
const nullableLatitudeSchema = (label) => z
    .union([z.number(), z.string(), z.null(), z.undefined()])
    .transform((value) => {
    if (value === null || value === undefined) {
        return null;
...
export const projectTransitionSchema = z
    ...
    if ((value.toStatus === "CANCELLED" || value.toStatus === "ON_HOLD") &&
        !value.reason) {
        context.addIssue({
            code: "custom",
