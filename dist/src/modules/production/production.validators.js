...
export const consumeMaterialForTaskSchema = z
    ...
    remnantOutput: z.union([remnantOutputSchema, z.null(), z.undefined()]).transform((value) => value ?? null),
    remnantPieceId: nullableUuidSchema,
    scrapQuantity: nullableNumberSchema({
        label: "Cantidad desechada",
        min: 0,
    }),
    scrapUnit: z.union([materialUnitSchema, z.null(), z.undefined()]).transform((value) => value ?? null),
