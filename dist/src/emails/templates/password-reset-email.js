...
export const passwordResetEmailTemplate = {
    ...
    `;
        return {
            ...
            text: joinTextBlocks(greeting(variables.userName), `Recibimos una solicitud para restablecer la contraseña de ${appName}.`, variables.expiresIn ? `Este enlace de restablecimiento vence en ${variables.expiresIn}.` : undefined, variables.resetLink, "Si no solicitaste esto, puedes ignorar este correo."),
        };
    },
    sampleVariables: {
