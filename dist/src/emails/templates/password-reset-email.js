...
export const passwordResetEmailTemplate = {
    ...
    `;
        return {
            ...
            text: joinTextBlocks(greeting(variables.userName), `We received a request to reset your ${appName} password.`, variables.expiresIn ? `This reset link expires in ${variables.expiresIn}.` : undefined, variables.resetLink, "If you did not request this, you can safely ignore this email."),
        };
    },
    sampleVariables: {
