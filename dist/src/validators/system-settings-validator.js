...
export const systemSettingKeyParamSchema = z.object({
    key: z
        ...
        .max(191)
        .regex(/^[a-z0-9._-]+$/i, {
        message: "Setting keys may only contain letters, numbers, periods, underscores, and hyphens.",
    }),
});
export const updateSystemSettingSchema = z.object({
    description: z
        ...
        .optional(),
    valueJson: z.custom((value) => isJsonValue(value), {
        message: "valueJson must be valid JSON data.",
    }),
});
//# sourceMappingURL=system-settings-validator.js.map