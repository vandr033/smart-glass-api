...
activityLogsRouter.get("/activity-logs", requirePermission("activity_logs.view"), asyncHandler(async (request, response) => {
...
//# sourceMappingURL=activity-logs-routes.js.map