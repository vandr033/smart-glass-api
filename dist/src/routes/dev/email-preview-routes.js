...
import { emailTemplateDefinitions, emailTemplateNames, isEmailTemplateName, } from "../../emails/templates/index.js";
import { asyncHandler } from "../../middleware/async-handler.js";
import { AppError } from "../../utils/app-error.js";
import { sendSuccess } from "../../utils/response.js";
const previewFormatSchema = z.enum(["html", "json"]).default("html");
const getPreviewOverrides = (query) => {
    const overrides = {};
...
emailPreviewRouter.get("/", asyncHandler(async (_request, response) => {
...
emailPreviewRouter.get("/:templateName", asyncHandler(async (request, response) => {
    ...
    const overrides = getPreviewOverrides(request.query);
    const variables = {
        ...sampleVariables,
        ...overrides,
    };
...
//# sourceMappingURL=email-preview-routes.js.map