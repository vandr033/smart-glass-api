...
productsRouter.get(
  "/products",
  requirePermission(PRODUCTS_PERMISSIONS.view),
...
productsRouter.post(
  "/products",
  requirePermission(PRODUCTS_PERMISSIONS.create),
  asyncHandler(productsController.create),
);

productsRouter.put(
  "/products/:id",
  requirePermission(PRODUCTS_PERMISSIONS.edit),
  asyncHandler(productsController.update),
);

productsRouter.delete(
  "/products/:id",
  requirePermission(PRODUCTS_PERMISSIONS.delete),
