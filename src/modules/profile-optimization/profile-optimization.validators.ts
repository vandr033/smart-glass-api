...
import {
  PROFILE_CUTTING_BAR_SOURCE_TYPES,
  PROFILE_CUTTING_PLAN_STATUSES,
  PROFILE_OPTIMIZATION_MODES,
  PROFILE_OPTIMIZATION_RUN_STATUSES,
  PROFILE_REMNANT_OUTPUT_STATUSES,
...
const positiveIntegerSchema = (label: string) =>
  z.coerce.number().int({
...
export const profileOptimizationRunStatusSchema = z.enum(
  PROFILE_OPTIMIZATION_RUN_STATUSES,
);
export const profileOptimizationModeSchema = z.enum(
  PROFILE_OPTIMIZATION_MODES,
);
export const profileCuttingPlanStatusSchema = z.enum(
  PROFILE_CUTTING_PLAN_STATUSES,
);
export const profileCuttingBarSourceSchema = z.enum(
  PROFILE_CUTTING_BAR_SOURCE_TYPES,
);
export const profileRemnantOutputStatusSchema = z.enum(
  PROFILE_REMNANT_OUTPUT_STATUSES,
);
