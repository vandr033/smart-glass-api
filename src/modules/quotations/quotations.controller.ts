...
const getRequiredQuotationItemId = (
...
const canViewCosts = (request: Request) =>
  request.authorizationSummary?.permissions.includes(
    QUOTATION_PERMISSIONS.viewCost,
  ) ?? false;

const canOverrideCosts = (request: Request) =>
  request.authorizationSummary?.permissions.includes(
    QUOTATION_PERMISSIONS.overrideCost,
  ) ?? false;

const canApprove = (request: Request) =>
  request.authorizationSummary?.permissions.includes(
    QUOTATION_PERMISSIONS.approve,
  ) ?? false;

const canSend = (request: Request) =>
  request.authorizationSummary?.permissions.includes(
...
export const quotationsController = {
  ...
  async getQuotationById(request: Request, response: Response) {
  ...
  async createQuotation(request: Request, response: Response) {
  ...
  async updateQuotation(request: Request, response: Response) {
    const quotationId = getRequiredQuotationId(request.params.id);
    const payload = quotationMutationSchema.parse(request.body);
    const actorContext = getRequestLogActorContext(request);
  ...
  async deleteQuotation(request: Request, response: Response) {
    const quotation = await quotationsService.deleteQuotation(
      getRequiredQuotationId(request.params.id),
    );
  ...
  async addTemplateItem(request: Request, response: Response) {
    const quotationId = getRequiredQuotationId(request.params.id);
    const payload = addTemplateQuotationItemSchema.parse(request.body);
    const actorContext = getRequestLogActorContext(request);
    const result = await quotationsService.addTemplateQuotationItem(
      quotationId,
      payload,
      actorContext.userId ?? null,
      {
  ...
  async addManualMaterialItem(request: Request, response: Response) {
    const quotationId = getRequiredQuotationId(request.params.id);
    const payload = addManualMaterialItemSchema.parse(request.body);
    const result = await quotationsService.addManualMaterialItem(
      quotationId,
      payload,
      {
        canViewCost: canViewCosts(request),
  ...
  async addManualServiceItem(request: Request, response: Response) {
    const quotationId = getRequiredQuotationId(request.params.id);
    const payload = addManualServiceItemSchema.parse(request.body);
    const result = await quotationsService.addManualServiceItem(
      quotationId,
      payload,
      {
        canViewCost: canViewCosts(request),
  ...
  async updateQuotationItem(request: Request, response: Response) {
  ...
  async deleteQuotationItem(request: Request, response: Response) {
    const itemId = getRequiredQuotationItemId(request.params.itemId);
  ...
  async recalculateQuotation(request: Request, response: Response) {
    const quotationId = getRequiredQuotationId(request.params.id);
    const actorContext = getRequestLogActorContext(request);
  ...
  async createQuotationVersion(request: Request, response: Response) {
    const quotationId = getRequiredQuotationId(request.params.id);
    const actorContext = getRequestLogActorContext(request);
  ...
  async submitQuotationForApproval(request: Request, response: Response) {
    const quotationId = getRequiredQuotationId(request.params.id);
    const payload = submitQuotationApprovalSchema.parse(request.body ?? {});
    const actorContext = getRequestLogActorContext(request);
    const result = await quotationsService.submitQuotationForApproval(
      quotationId,
      payload,
      {
        canViewCost: canViewCosts(request),
  ...
  async approveQuotation(request: Request, response: Response) {
    const quotationId = getRequiredQuotationId(request.params.id);
  ...
  async rejectQuotation(request: Request, response: Response) {
    const quotationId = getRequiredQuotationId(request.params.id);
    const payload = quotationDecisionSchema.parse(request.body ?? {});
    const actorContext = getRequestLogActorContext(request);
  ...
  async changeQuotationStatus(request: Request, response: Response) {
    const quotationId = getRequiredQuotationId(request.params.id);
  ...
  async listQuotationVersions(request: Request, response: Response) {
    const quotationId = getRequiredQuotationId(request.params.id);
  ...
  async listQuotationApprovals(request: Request, response: Response) {
    const quotationId = getRequiredQuotationId(request.params.id);
  ...
  async listPendingApprovals(_request: Request, response: Response) {
