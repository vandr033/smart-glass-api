...
export const cuttingOptimizationRunStatusSchema = z.enum(
  CUTTING_OPTIMIZATION_RUN_STATUSES,
);
...
export const cuttingPlanRemnantOutputStatusSchema = z.enum(
  CUTTING_PLAN_REMNANT_OUTPUT_STATUSES,
);
