...
const normalizedTextSchema = (maxLength: number, label: string) =>
  z
...
const normalizedDateSchema = (label: string) =>
  z
...
export const clientPortalQuotationDecisionSchema = z
  ...
  .refine(
    (value) => value.decision === "ACEPTAR" || (value.motivo ?? "").length > 0,
    {
...
export type UpdateClientPortalUserInput = z.infer<typeof updateClientPortalUserSchema>;
export type ChangeClientPortalUserStatusInput = z.infer<
  typeof changeClientPortalUserStatusSchema
>;
export type ClientPortalLoginInput = z.infer<typeof clientPortalLoginSchema>;
export type ClientPortalForgotPasswordInput = z.infer<
  typeof clientPortalForgotPasswordSchema
>;
export type ClientPortalResetPasswordInput = z.infer<typeof clientPortalResetPasswordSchema>;
export type ClientPortalAcceptInvitationInput = z.infer<
  typeof clientPortalAcceptInvitationSchema
>;
export type ClientPortalQuotationDecisionInput = z.infer<
  typeof clientPortalQuotationDecisionSchema
>;
export type CreateClientPortalDocumentInput = z.infer<
  typeof createClientPortalDocumentSchema
>;
export type CreateClientPortalMessageInput = z.infer<
  typeof createClientPortalMessageSchema
>;
export type CreateInternalClientPortalMessageInput = z.infer<
  typeof createInternalClientPortalMessageSchema
>;
export type CreatePortalPostventaCaseInput = z.infer<
  typeof createPortalPostventaCaseSchema
>;
export type ListPortalMessagesQuery = z.infer<typeof listPortalMessagesQuerySchema>;
