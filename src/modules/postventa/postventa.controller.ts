...
const getActorUserId = (request: Request): string | null => {
...
export const postventaController = {
  async listCases(request: Request, response: Response) {
  ...
  async createCaseFromClient(request: Request, response: Response) {
    const payload = createPostventaCaseSchema.parse(request.body);
    const { clientId } = clientIdParamSchema.parse(request.params);
    const result = await postventaService.createCaseFromClient(
      clientId,
      payload,
  ...
  async createCaseFromProject(request: Request, response: Response) {
    const payload = createPostventaCaseSchema.parse(request.body);
    const { projectId } = projectIdParamSchema.parse(request.params);
    const result = await postventaService.createCaseFromProject(
      projectId,
      payload,
      getActorUserId(request),
    );
  ...
  async createCaseFromInstallation(request: Request, response: Response) {
    const payload = createPostventaCaseSchema.parse(request.body);
    const { installationId } = installationIdParamSchema.parse(request.params);
    const result = await postventaService.createCaseFromInstallation(
      installationId,
      payload,
      getActorUserId(request),
    );
  ...
  async updateCase(request: Request, response: Response) {
    const { id } = postventaCaseIdParamSchema.parse(request.params);
  ...
  async assignCase(request: Request, response: Response) {
    const { id } = postventaCaseIdParamSchema.parse(request.params);
    const before = await postventaService.getCaseById(id);
  ...
  async changeCaseStatus(request: Request, response: Response) {
    const { id } = postventaCaseIdParamSchema.parse(request.params);
    const before = await postventaService.getCaseById(id);
    const payload = changePostventaCaseStatusSchema.parse(request.body);
    const result = await postventaService.changeCaseStatus(
      id,
      payload,
      getActorUserId(request),
    );
  ...
  async closeCase(request: Request, response: Response) {
    const { id } = postventaCaseIdParamSchema.parse(request.params);
    const before = await postventaService.getCaseById(id);
    const payload = closePostventaCaseSchema.parse(request.body);
    const result = await postventaService.closeCase(
      id,
      payload,
      getActorUserId(request),
    );
  ...
  async createWarranty(request: Request, response: Response) {
  ...
  async updateWarranty(request: Request, response: Response) {
  ...
  async createActivity(request: Request, response: Response) {
    ...
    const result = await postventaService.createActivity(
      id,
      payload,
      getActorUserId(request),
    );
  ...
  async updateActivity(request: Request, response: Response) {
    ...
    const result = await postventaService.updateActivity(
      activityId,
      payload,
      getActorUserId(request),
    );
  ...
  async createEvidence(request: Request, response: Response) {
    const { id } = postventaCaseIdParamSchema.parse(request.params);
    ...
    const result = await postventaService.createEvidence(
      id,
      payload,
      {
  ...
  async createCost(request: Request, response: Response) {
    const { id } = postventaCaseIdParamSchema.parse(request.params);
  ...
  async createReservation(request: Request, response: Response) {
    ...
    const before = await postventaService.getCaseById(id);
    const result = await postventaService.createInventoryReservation(
      id,
      payload,
      getActorUserId(request),
    );
  ...
  async consumeReservation(request: Request, response: Response) {
    const { reservationLinkId } = postventaReservationLinkIdParamSchema.parse(
      request.params,
    );
    const payload = consumePostventaReservationSchema.parse(request.body);
    const result = await postventaService.consumeInventoryReservation(
      reservationLinkId,
      payload,
      getActorUserId(request),
    );
  ...
  async releaseReservation(request: Request, response: Response) {
    ...
    const result = await postventaService.releaseInventoryReservation(
      reservationLinkId,
      getActorUserId(request),
    );
