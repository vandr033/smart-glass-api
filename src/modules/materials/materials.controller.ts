...
import {
  MATERIAL_CATEGORY_ENTITY_TYPE,
  MATERIAL_DIMENSION_PRESET_ENTITY_TYPE,
  MATERIAL_ENTITY_TYPE,
  MATERIALS_PERMISSIONS,
  SUPPLIER_MATERIAL_EQUIVALENCE_ENTITY_TYPE,
...
import {
  ...
  materialDimensionPresetParamsSchema,
  materialIdParamSchema,
  supplierMaterialEquivalenceIdParamSchema,
...
const getRequiredMaterialCategoryId = (
...
const getRequiredDimensionPresetParams = (
...
const getRequiredSupplierMaterialEquivalenceId = (
  value: string | string[] | undefined,
): string => {
...
export const materialsController = {
  async listMaterialCategories(request: Request, response: Response) {
  ...
  async createMaterialCategory(request: Request, response: Response) {
  ...
  async updateMaterialCategory(request: Request, response: Response) {
  ...
  async deleteMaterialCategory(request: Request, response: Response) {
    const category = await materialsService.deleteMaterialCategory(
      getRequiredMaterialCategoryId(request.params.id),
    );
  ...
  async listMaterials(request: Request, response: Response) {
    const query = listMaterialsQuerySchema.parse({
      ...
      isRemnantEligible: getQueryValue(
        request.query["filter.isRemnantEligible"],
      ),
  ...
  async getMaterialById(request: Request, response: Response) {
    const material = await materialsService.getMaterialById(
      getRequiredMaterialId(request.params.id),
    );

    sendSuccess(response, material);
  },

  async createMaterial(request: Request, response: Response) {
  ...
  async updateMaterial(request: Request, response: Response) {
  ...
  async deleteMaterial(request: Request, response: Response) {
    const material = await materialsService.deleteMaterial(
      getRequiredMaterialId(request.params.id),
    );
  ...
  async listMaterialDimensionPresets(request: Request, response: Response) {
    const presets = await materialsService.listMaterialDimensionPresets(
      getRequiredMaterialId(request.params.id),
    );
  ...
  async createMaterialDimensionPreset(request: Request, response: Response) {
    const materialId = getRequiredMaterialId(request.params.id);
    const payload = createMaterialDimensionPresetSchema.parse(request.body);
    const preset = await materialsService.createMaterialDimensionPreset(
      materialId,
      payload,
    );
  ...
  async updateMaterialDimensionPreset(request: Request, response: Response) {
    const params = getRequiredDimensionPresetParams(
      request.params.id,
      request.params.presetId,
    );
    const payload = updateMaterialDimensionPresetSchema.parse(request.body);
    const result = await materialsService.updateMaterialDimensionPreset(
      params.id,
      params.presetId,
      payload,
    );
  ...
  async deleteMaterialDimensionPreset(request: Request, response: Response) {
    const params = getRequiredDimensionPresetParams(
      request.params.id,
      request.params.presetId,
    );
    const preset = await materialsService.deleteMaterialDimensionPreset(
      params.id,
      params.presetId,
    );
  ...
  async listSupplierMaterialEquivalences(request: Request, response: Response) {
  ...
  async createSupplierMaterialEquivalence(request: Request, response: Response) {
  ...
  async updateSupplierMaterialEquivalence(request: Request, response: Response) {
    ...
    const result = await materialsService.updateSupplierMaterialEquivalence(
      equivalenceId,
      payload,
    );
  ...
  async deleteSupplierMaterialEquivalence(request: Request, response: Response) {
    const record = await materialsService.deleteSupplierMaterialEquivalence(
      getRequiredSupplierMaterialEquivalenceId(request.params.id),
    );
  ...
  async verifySupplierMaterialEquivalence(request: Request, response: Response) {
    const equivalenceId = getRequiredSupplierMaterialEquivalenceId(request.params.id);
    const result = await materialsService.verifySupplierMaterialEquivalence(
      equivalenceId,
    );
  ...
  async mapSupplierMaterialEquivalence(request: Request, response: Response) {
    const equivalenceId = getRequiredSupplierMaterialEquivalenceId(request.params.id);
    const payload = mapSupplierMaterialEquivalenceSchema.parse(request.body);
    const result = await materialsService.mapSupplierMaterialEquivalence(
      equivalenceId,
      payload,
    );
