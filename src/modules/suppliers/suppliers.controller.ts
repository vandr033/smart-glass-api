...
import {
  SUPPLIER_CATEGORY_ENTITY_TYPE,
  SUPPLIER_CONTACT_ENTITY_TYPE,
  SUPPLIER_ENTITY_TYPE,
  SUPPLIER_SCORING_CONFIG_ENTITY_TYPE,
...
import {
  ...
  supplierCategoryIdParamSchema,
  supplierContactParamsSchema,
  supplierIdParamSchema,
  supplierScoringConfigIdParamSchema,
...
const getRequiredCategoryId = (value: string | string[] | undefined): string => {
...
const getRequiredConfigId = (value: string | string[] | undefined): string => {
...
export const suppliersController = {
  async listSuppliers(request: Request, response: Response) {
  ...
  async getSupplierById(request: Request, response: Response) {
    const supplier = await suppliersService.getSupplierById(
      getRequiredSupplierId(request.params.id),
    );
  ...
  async listSupplierContacts(request: Request, response: Response) {
    const contacts = await suppliersService.listSupplierContacts(
      getRequiredSupplierId(request.params.id),
    );
  ...
  async createSupplierContact(request: Request, response: Response) {
    const supplierId = getRequiredSupplierId(request.params.id);
  ...
  async updateSupplierContact(request: Request, response: Response) {
    const params = getRequiredContactParams(
      request.params.id,
      request.params.contactId,
    );
    const payload = updateSupplierContactSchema.parse(request.body);
    const result = await suppliersService.updateSupplierContact(
      params.id,
      params.contactId,
      payload,
    );
  ...
  async deleteSupplierContact(request: Request, response: Response) {
    const params = getRequiredContactParams(
      request.params.id,
      request.params.contactId,
    );
    const contact = await suppliersService.deleteSupplierContact(
      params.id,
      params.contactId,
    );
  ...
  async listSupplierCategories(request: Request, response: Response) {
  ...
  async createSupplierCategory(request: Request, response: Response) {
  ...
  async updateSupplierCategory(request: Request, response: Response) {
    const payload = updateSupplierCategorySchema.parse(request.body);
    const result = await suppliersService.updateCategory(
      getRequiredCategoryId(request.params.id),
      payload,
    );
  ...
  async deleteSupplierCategory(request: Request, response: Response) {
  ...
  async listScoringCriteria(_request: Request, response: Response) {
    const criteria = await supplierScoringService.listCriteria();
    sendSuccess(response, criteria);
  },

  async listScoringConfigs(request: Request, response: Response) {
  ...
  async getScoringConfigById(request: Request, response: Response) {
    const config = await supplierScoringService.getConfigById(
      getRequiredConfigId(request.params.id),
    );

    sendSuccess(response, config);
  },

  async createScoringConfig(request: Request, response: Response) {
  ...
  async updateScoringConfig(request: Request, response: Response) {
  ...
  async deleteScoringConfig(request: Request, response: Response) {
    const config = await supplierScoringService.deleteConfig(
      getRequiredConfigId(request.params.id),
    );
  ...
  async simulateScoring(request: Request, response: Response) {
