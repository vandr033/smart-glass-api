...
import {
  ...
  productTemplateVersionIdParamSchema,
...
export const productTemplatesController = {
  ...
  async getTemplateById(request: Request, response: Response) {
    const template = await productTemplatesService.getProductTemplateById(
      getRequiredTemplateId(request.params.id),
    );
  ...
  async createTemplate(request: Request, response: Response) {
    ...
    const actorContext = getRequestLogActorContext(request);
    const template = await productTemplatesService.createProductTemplate(
      payload,
  ...
  async updateTemplate(request: Request, response: Response) {
    ...
    const result = await productTemplatesService.updateProductTemplate(
      templateId,
      payload,
    );
  ...
  async deleteTemplate(request: Request, response: Response) {
    const template = await productTemplatesService.deleteProductTemplate(
      getRequiredTemplateId(request.params.id),
    );
  ...
  async listTemplateVersions(request: Request, response: Response) {
    const versions = await productTemplatesService.listTemplateVersions(
      getRequiredTemplateId(request.params.id),
    );
  ...
  async createTemplateVersion(request: Request, response: Response) {
    const templateId = getRequiredTemplateId(request.params.id);
    const payload = createProductTemplateVersionSchema.parse(request.body);
    const actorContext = getRequestLogActorContext(request);
    const version = await productTemplatesService.createTemplateVersion(
      templateId,
      payload,
      actorContext.userId ?? null,
    );
  ...
  async getTemplateVersionById(request: Request, response: Response) {
    const version = await productTemplatesService.getProductTemplateVersionById(
      getRequiredVersionId(request.params.versionId),
    );

    sendSuccess(response, version);
  },

  async updateTemplateVersion(request: Request, response: Response) {
    ...
    const result = await productTemplatesService.updateProductTemplateVersion(
      versionId,
      payload,
    );
  ...
  async updateTemplateVersionRules(request: Request, response: Response) {
    const versionId = getRequiredVersionId(request.params.versionId);
    const payload = updateProductTemplateRulesSchema.parse(request.body);
    const result = await productTemplatesService.updateTemplateVersionRules(
      versionId,
      payload,
    );
  ...
  async activateTemplateVersion(request: Request, response: Response) {
    const versionId = getRequiredVersionId(request.params.versionId);
    const actorContext = getRequestLogActorContext(request);
    const version = await productTemplatesService.activateTemplateVersion(
      versionId,
      actorContext.userId ?? null,
    );
  ...
  async simulateTemplateVersion(request: Request, response: Response) {
    const versionId = getRequiredVersionId(request.params.versionId);
  ...
  async listTemplateVersionSimulations(request: Request, response: Response) {
    const versionId = getRequiredVersionId(request.params.versionId);
    ...
    const result = await productTemplatesService.listTemplateSimulations(
      versionId,
      query,
    );
