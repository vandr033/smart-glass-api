...
productionRouter.get(
  "/production/tablero",
  advancedRead,
  asyncHandler(productionBoardController.getBoard),
);
productionRouter.get(
  "/production/resumen",
  advancedRead,
  asyncHandler(productionBoardController.getSummary),
);
productionRouter.get(
  "/production/centros-trabajo",
  advancedRead,
  asyncHandler(productionBoardController.listWorkCenters),
);
productionRouter.get(
  "/production/capacidad",
  advancedRead,
  asyncHandler(productionBoardController.getCapacity),
);
productionRouter.get(
  "/production/calendario",
  advancedRead,
  asyncHandler(productionBoardController.getCalendar),
);
productionRouter.get(
  "/production/reportes",
  advancedRead,
  asyncHandler(productionBoardController.getReports),
);
productionRouter.get(
  "/production/bloqueos",
  advancedRead,
  asyncHandler(productionBoardController.listBlocks),
);
...
productionRouter.post(
  "/production/ordenes/:id/programar",
  advancedPlan,
  asyncHandler(productionBoardController.scheduleJob),
);
productionRouter.post(
  "/production/ordenes/:id/reprogramar",
  requireAnyPermission([
...
productionRouter.post(
  "/production/ordenes/:id/transicion",
  advancedPlan,
  asyncHandler(productionBoardController.transitionJob),
);
productionRouter.post(
...
productionRouter.post(
  "/production/tareas/:taskId/iniciar",
  advancedExecute,
  asyncHandler(productionBoardController.transitionTask),
);
productionRouter.post(
  "/production/tareas/:taskId/pausar",
  advancedExecute,
  asyncHandler(productionBoardController.transitionTask),
);
productionRouter.post(
  "/production/tareas/:taskId/reanudar",
  advancedExecute,
  asyncHandler(productionBoardController.transitionTask),
);
productionRouter.post(
  "/production/tareas/:taskId/bloquear",
  requireAnyPermission([
    PRODUCTION_PERMISSIONS.blocksCreate,
    PRODUCTION_PERMISSIONS.update,
  ]),
...
productionRouter.post(
  "/production/tareas/:taskId/desbloquear",
  advancedExecute,
  asyncHandler(productionBoardController.transitionTask),
);
productionRouter.post(
  "/production/tareas/:taskId/enviar-control",
  requireAnyPermission([
...
productionRouter.post(
  "/production/tareas/:taskId/completar",
  requireAnyPermission([
