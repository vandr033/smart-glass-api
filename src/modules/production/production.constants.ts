...
export const PRODUCTION_BLOCK_SEVERITIES = ["LOW", "MEDIUM", "HIGH", "CRITICAL"] as const;
export const PRODUCTION_BLOCK_STATUSES = ["OPEN", "UNDER_REVIEW", "IN_PROGRESS", "RESOLVED", "DISMISSED"] as const;
export const PRODUCTION_TASK_DEPENDENCY_TYPES = ["FINISH_TO_START", "START_TO_START", "FINISH_TO_FINISH"] as const;
export const PRODUCTION_TIME_EVENT_TYPES = ["START", "PAUSE", "RESUME", "BLOCK", "UNBLOCK", "FINISH"] as const;
export const PRODUCTION_WASTE_ENTRY_TYPES = ["WASTE", "SCRAP", "REMNANT"] as const;
