  ...
  render: ({ brand, variables }) => {
    ...
    return {
      ...
      text: joinTextBlocks(
        ...
        variables.roleName ? `Role: ${variables.roleName}` : undefined,
        variables.invitedByName ? `Invitation sent by ${variables.invitedByName}.` : undefined,
        variables.expiresAt ? `Expires on ${variables.expiresAt}.` : undefined,
